...
3. WHEN the reword targets a building block created in the *same* contribution THEN it SHALL
   NOT be held (the person is still authoring that block).
