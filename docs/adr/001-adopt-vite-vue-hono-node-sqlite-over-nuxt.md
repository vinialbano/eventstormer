...
- **Date**: 2026-08-24
- **Status**: Accepted — the stack stands; the **layout** section is superseded by [ADR-002](002-context-first-layout-and-context-integration.md) (context-first, not layer-first), and the `FACILITATOR_MODEL` default changes to `claude-sonnet-5` per [ADR-005](005-ai-facilitator.md)
