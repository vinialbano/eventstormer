...
| `bounded-contexts/*/canvas.md` (event-stormed model sections) | `UNCONFIRMED` | — | Deliberately deferred — needs a Process Modelling or Design-Level pass per context; "the capture loop" process now exists but has not yet been folded back into a canvas. Session Facilitation's canvas additionally carries the merged-in Question & Hot Spot Resolution content (`[from QHSR]`), itself still `UNCONFIRMED` pending a Design-Level pass on Facilitation |
...
| `context-map.md` (decided form) | draft, confirmed strategically | High | Every relationship reasoned through the U/D test and confirmed with the participant; the 2026-08-26 Question & Hot Spot Resolution collapse is now adopted and reflected in the diagram/table |
...
| `open-questions.md` | draft, live | — | Storm-originated hot spots + 5 items from the strategic-design session (7–11) + 3 items from Process Modelling (13–15) + 4 items from Design-Level (17–20), #17/#20 now resolved |

## Next steps (named, not started)

- Design-Level on Session Facilitation (now including hot spot/question resolution) — the
  resolution invariant and read model found in `sessions/2026-08-26-design-level.md` are
  ready-made input, not re-elicitation.
...
- A PRD update to F08 (and F01's operation-log kind list), to specify the resolve/close mechanic
  this session found missing, now known to live in Session Facilitation (open-questions.md #19).
...
| [bounded-contexts/session-facilitation/canvas.md](bounded-contexts/session-facilitation/canvas.md) | ddd-strategic-design | eventstormer-session | draft | 2026-08-26 |
| [bounded-contexts/session-facilitation/ubiquitous-language.md](bounded-contexts/session-facilitation/ubiquitous-language.md) | ddd-strategic-design | eventstormer-session | draft | 2026-08-26 |
| [context-map.md](context-map.md) | ddd-strategic-design | eventstormer-session | draft | 2026-08-26 |
| [domain-and-goals.md](domain-and-goals.md) | ddd-strategic-design | eventstormer-session | draft | 2026-08-25 |
| [open-questions.md](open-questions.md) | ddd-strategic-design | eventstormer-session | draft | 2026-08-26 |
